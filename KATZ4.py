...
for h in range(100):
    ...
    for i in range(5):
        ...
        #print(f[i])
        test_sample = np.array(f[i])# 多行两列矩阵   存的是一的坐标
        # 自己写的代码，20，2，19，2
        ...
        PK4 = PK4.T    # 转置
        test_sample_number = test_sample.shape[0]    # 取测试样本的行
        ...
        score = PK4[sample[:, 0],sample[:, 1]] # 因为之前已经有19或20个数变了，所以取得预测值也就变了，目的是取预测值，一行860/859列
        # print(score.shape)
